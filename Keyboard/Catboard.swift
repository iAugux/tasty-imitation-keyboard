...
class Catboard: KeyboardViewController {
    ...
    func takeScreenshotDelay() {
        let _ = NSTimer.scheduledTimerWithTimeInterval(0.1, target: self, selector: Selector("takeScreenshot"), userInfo: nil, repeats: false)
    }
...
//            let context = UIGraphicsGetCurrentContext()
            ...
            if let pngR = UIImagePNGRepresentation(capturedImage) {
                pngR.writeToFile(imagePath, atomically: true)
            }
